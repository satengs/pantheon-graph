...
export const RULE_SCOPE: Record<string, string> = {
  ...
  S06: "Sibling brands may declare a corporate relationship. They must not share a product super-node or a license ID. Google collapsing two brands under one Debt Relief Services + NMLS is this rule failing.",
  ...
  S12: "NMLS and origination-fee language only on LoanOrCredit URLs. Settlement and debt-relief pages never emit NMLS. A shared NMLS in AI overviews is this rule failing across brands.",
  ...
  S22: "Two brands may both sell the same class of product. Do not 301 one live product to the other. Two Service nodes, two Organization @ids. Do not let an AI overview hang both off one hub.",
